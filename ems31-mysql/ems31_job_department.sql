...
CREATE TABLE `job_department` (
  ...
  `Salary_Grade` varchar(30) NOT NULL,
  PRIMARY KEY (`Job_ID`)
...
INSERT INTO `job_department` VALUES (189021,'Finance Department','Chittagong','A'),(189022,'Sales Department','Dhaka','A'),(189023,'Human Resource ','Rajshahi','C');
